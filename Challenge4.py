#1 create the login function to return the Token
#2 create the tenant Acme
#3 create Application Accounting
#4 Create teh EPG Payroll
#5 create the EPG Bills
#First--------Teaach RESTful and json---------------------------
import requests
import json
#1
...
#2 copy from tenant build lab to build new tenant acme
