#1 On the ASAv, add a network object named Development with an ip 100.1.1.1.

import requests

url = "https://192.168.10.100/api/objects/networkobjects"

payload = "{\r\n  \"host\": {\r\n    \"kind\": \"IPv4Address\",\r\n    \"value\": \"100.1.1.1\"\r\n  },\r\n  \"kind\": \"object#NetworkObj\",\r\n  \"name\": \"ASA_Development_Challenge3\",\r\n  \"objectId\": \"ASA_Development_NObj_Challenge3\"\r\n}"
headers = {
...
#2 on NXOSv add 2 vlan's 600 name Construction and 700 name Analysis
...
payload = {
  "ins_api": {
    ...
    "chunk": "0",
    "sid": "1",
    "input": "config t  ;vlan 600 ;name Construction ;config t ;vlan 700 ;name Analysis",
    "output_format": "json"
  }
}
response = requests.post(url,data=json.dumps(payload), headers=myheaders,auth=(switchuser,switchpassword)).json()

#3 On IOS XE, add a static route 216.48.1.0/24
